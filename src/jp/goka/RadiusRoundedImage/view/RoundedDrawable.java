...
public class RoundedDrawable extends Drawable {
  ...
  private boolean mTargetRadius = false;
  private float mBorderWidth = 0;
  private int mTopLeft = 0;
  private int mTopRight = 0;
  private int mBottomRight = 0;
  private int mBottomLeft = 0;
  ...
  public RoundedDrawable setTargetRadius(int topLeft, int topRight, int bottomRight, int bottomLeft) {
      mTopLeft = topLeft;
      mTopRight = topRight;
  ...
  public RoundedDrawable setTargetRadius(boolean targetRadius) {
